...
ENV_JSON=$(jq '.parameters = {
    ...
    "CeilometerDbPassword": "'"${UNDERCLOUD_CEILOMETER_DB_PASSWORD}"'",
    "SnmpdReadonlyUserPassword": "'"${UNDERCLOUD_CEILOMETER_SNMPD_PASSWORD}"'",
    "GlanceDbPassword": "'"${UNDERCLOUD_GLANCE_DB_PASSWORD}"'",
    "GlancePassword": "'"${UNDERCLOUD_GLANCE_PASSWORD}"'",
    "HeatDbPassword": "'"${UNDERCLOUD_HEAT_DB_PASSWORD}"'",
    "HeatPassword": "'"${UNDERCLOUD_HEAT_PASSWORD}"'",
    "KeystoneDbPassword": "'"${UNDERCLOUD_KEYSTONE_DB_PASSWORD}"'",
    "NovaDbPassword": "'"${UNDERCLOUD_NOVA_DB_PASSWORD}"'",
    "NovaPassword": "'"${UNDERCLOUD_NOVA_PASSWORD}"'",
    "NeutronDbPassword": "'"${UNDERCLOUD_NEUTRON_DB_PASSWORD}"'",
