...
##
## .. [#f4] Requirements for using real bare metal
## 
##    If you don't use create-nodes, but want to use real bare metal see the
##    following suggestions.
## 
##    * before calling setup-baremetal you can set MACS, PM_IPS, PM_USERS,
