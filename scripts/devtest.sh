...
TEMP=$(getopt -o h,c -l existing-environment,trash-my-machine,bridge-seed-to-interface:,nodes: -n $SCRIPT_NAME -- "$@")
...
while true ; do
    case "$1" in
        ...
        --bridge-to-interface) BRIDGE_INTERFACE="--bridge-seed-to-interface $2"; shift 2;;
