...
export SEED_VM_IP=${SEED_VM_IP:-'192.0.2.1'}
export UNDERCLOUD_OVS_IP=${UNDERCLOUD_OVS_IP:-'192.0.2.4'}
export SEED_VM_IP_CIDR=${SEED_VM_IP_CIDR:-'192.0.2.1/24'}
export CTLPLANE_CIDR=${CTLPLANE_CIDR:-'192.0.2.0/24'}

export UNDERCLOUD_FLOAT_START=${UNDERCLOUD_FLOAT_START:-'192.0.2.2'}
export UNDERCLOUD_FLOAT_END=${UNDERCLOUD_FLOAT_END:-'192.0.2.20'}
export UNDERCLOUD_FLOAT_GATEWAY=${UNDERCLOUD_FLOAT_GATEWAY:-'192.0.2.1'}

export OVERCLOUD_FLOAT_START=${OVERCLOUD_FLOAT_START:-'192.0.2.21'}
export OVERCLOUD_FLOAT_END=${OVERCLOUD_FLOAT_END:-'192.0.2.40'}
export OVERCLOUD_FLOAT_GATEWAY=${OVERCLOUD_FLOAT_GATEWAY:-'192.0.2.1'}

export FLOATING_START=${FLOATING_START:-'192.0.2.45'}
export FLOATING_END=${FLOATING_END:-'192.0.2.64'}
export FLOATING_CIDR=${FLOATING_CIDR:-'192.0.2.0/24'}
export ABOVECLOUD_CIDR=${ABOVECLOUD_CIDR:-'10.128.0.0/9'}
