...
## #. It's posible to deploy Undercloud without UI and its dependent elements.
##    The dependent image elements in Undercloud are Horizon, Tuskar-UI and
##    Ceilometer. In Overcloud it is SNMPd image element on every node.
##    ::
