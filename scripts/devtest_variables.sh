...
## #. We now support Ironic as the baremetal deployment layer. To disable it just
##    set ``USE_IRONIC=0``. Note however that Nova Baremetal is deprecated in
##    Nova and TripleO, and support will be removed once it is removed from Nova.
##    ::
