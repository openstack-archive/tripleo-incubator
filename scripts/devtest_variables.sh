...
## #. Set ``USE_CEPH=1`` if you want Cinder to be configured with Ceph as its
##    backend. Enabled by default when ``OVERCLOUD_CEPHSTORAGESCALE`` is > 0
##    ::
