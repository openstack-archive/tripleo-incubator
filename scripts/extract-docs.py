...
def main():
    ...
    Otherwise processing will start from the first --include"""

    parser = argparse.ArgumentParser(
        description="Process a file for ingestion by Sphinx")
    parser.add_argument('filename', help="Name of file to ingest")
    parser.add_argument('--begin_enabled', type=bool, default=False)

    args = parser.parse_args()

    # filename, begin_enabled=False)
    _enabled = args.begin_enabled
