...
##         NODE_CPU=1 NODE_MEM=2572 NODE_DISK=40 NODE_ARCH=i386

NODE_CPU=${NODE_CPU:-1} NODE_MEM=${NODE_MEM:-2572} NODE_DISK=${NODE_DISK:-40} NODE_ARCH=${NODE_ARCH:-i386} NODE_CNT=${NODE_CNT:-15} #nodocs
