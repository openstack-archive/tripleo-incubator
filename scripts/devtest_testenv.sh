...
##    ::
##
##         NODE_CPU=1 NODE_MEM=2048 NODE_DISK=30 NODE_EPHEMERAL_DISK=20 NODE_ARCH=i386
##
NODE_CPU=${NODE_CPU:-1} NODE_MEM=${NODE_MEM:-2048} NODE_ARCH=${NODE_ARCH:-i386} #nodocs
NODE_DISK=${NODE_DISK:-30} NODE_EPHEMERAL_DISK=${NODE_EPHEMERAL_DISK:-20} #nodocs
...
create-nodes $NODE_CPU $NODE_MEM $NODE_DISK $NODE_ARCH $NODE_CNT $SSH_USER $HOSTIP $JSONFILE "" $NODE_EPHEMERAL_DISK
