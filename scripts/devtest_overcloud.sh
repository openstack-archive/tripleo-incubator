...
TEMP=$(getopt -o c,h -l build-only,without-mergepy,debug-logging,heat-env:,compute-flavor:,control-flavor:,help -n $SCRIPT_NAME -- "$@")
...
while true ; do
    case "$1" in
        ...
        --without-mergepy USE_MERGEPY=0; shift 1;;
