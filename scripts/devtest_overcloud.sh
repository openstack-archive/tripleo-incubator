...
OVERCLOUD_BRIDGE_MAPPINGS=${OVERCLOUD_BRIDGE_MAPPINGS:-'datacentre'}
...
##    ::
    ...
    user-config
##             setup-neutron "" "" 10.0.0.0/8 10.0.0.1 "" "" 192.0.2.45 192.0.2.64 192.0.2.0/24
    setup-neutron "" "" $OVERCLOUD_FIXED_RANGE_CIDR $OVERCLOUD_FIXED_RANGE_GATEWAY "" "" $FLOATING_START $FLOATING_END $FLOATING_CIDR $NeutronPublicInterfaceTag #nodocs
