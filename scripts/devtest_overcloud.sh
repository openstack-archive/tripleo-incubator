...
ENV_JSON=$(jq '.parameters = {
    ...
    "KeystoneDbPassword": "'"${OVERCLOUD_KEYSTONE_DB_PASSWORD}"'",
    "NeutronBridgeMappings": "'"${OVERCLOUD_BRIDGE_MAPPINGS}"'",
    "NeutronFlatNetworks": "'"${OVERCLOUD_FLAT_NETWORKS}"'",
    "NeutronDbPassword": "'"${OVERCLOUD_NEUTRON_DB_PASSWORD}"'",
    ...
    "NovaDbPassword": "'"${OVERCLOUD_NOVA_DB_PASSWORD}"'",
