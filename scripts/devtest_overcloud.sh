...
FLOATING_START=${FLOATING_START:-'192.0.2.45'}
FLOATING_END=${FLOATING_END:-'192.0.2.64'}
FLOATING_CIDR=${FLOATING_CIDR:-'192.0.2.0/24'}
ADMIN_USERS=${ADMIN_USERS:-''}
USERS=${USERS:-''}

# NOTE(rpodolyaka): retain backwards compatibility by accepting positional arguments
#                   too. Positional arguments take precedence over env variables.
NeutronPublicInterface=${1:-$NeutronPublicInterface}
...
FLOATING_START=${5:-$FLOATING_START}
FLOATING_END=${6:-$FLOATING_END}
FLOATING_CIDR=${7:-$FLOATING_CIDR}
