...
## #. Create unique credentials(save to $TRIPLEO_ROOT/tripleo-overcloud-passwords
##    by default, and can be specified to other places by changing OVERCLOUD_PASSWORDS_FILE.)
##    ::

setup-overcloud-passwords $OVERCLOUD_PASSWORDS_FILE
source $OVERCLOUD_PASSWORDS_FILE
