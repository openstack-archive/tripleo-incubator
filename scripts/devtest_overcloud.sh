...
if [ "${USE_CEPH:-}" = 1 ] ; then
    ...
    OVERCLOUD_CONTROL_DIB_EXTRA_ARGS="$OVERCLOUD_CONTROL_DIB_EXTRA_ARGS cinder-tgt"
fi
...
function create_cephx_key() {
    # Taken from https://github.com/ceph/ceph-deploy/blob/15b348e502128df435f8c2c7073e8b936086e325/ceph_deploy/new.py#L21
