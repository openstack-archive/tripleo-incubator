...
# Deletes the ironic section as it not used in the configuration.
# Sets:
# - bm node arch
# - bm power manager
# - ssh power host
...
# Delete the nova.baremetal section as it not used in the configuration.
# Sets:
