...
3) Setup variables to override the normal DIB image elements::
    ...
    export OVERCLOUD_CEPHSTORAGE_DIB_ELEMENTS='sysctl ntp hosts baremetal dhcp-all-interfaces os-collect-config heat-config-puppet puppet-modules hiera os-net-config delorean-repo rdo-release
