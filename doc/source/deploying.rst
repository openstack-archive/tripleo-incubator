...
- register the undercloud machine with it's details rather than generic virtual
  ones - e.g.
...
- setup ec2 metadata support:
  ...
  -A PREROUTING -d 169.254.169.254/32 -i <external_interface> -p tcp -m tcp --dport 80 -j DNAT --to-destination <seedip>:8775
