...
1. Perform setup of your seed cloud.
        ...
        ##
1. Create a 'baremetal' node out of a KVM virtual machine and collect
   its MAC address.
   Nova will PXE boot this VM as though it is physical hardware.
   If you want to create the VM yourself, see footnote [2] for details on
...
1. Create two more 'baremetal' node(s) and register them with your undercloud.
        ##
