...
deployment of those images onto bare metal. Currently Heat drives the `Nova
baremetal driver <https://wiki.openstack.org/wiki/Baremetal>`_; however, this
will migrate to `Ironic <https://wiki.openstack.org/wiki/Ironic>` in the near
future.
