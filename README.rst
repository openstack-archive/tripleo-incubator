...
At this moment, the distributions that are tested by the CI systems are the
Ubuntu and Fedora. Currently, we specifically test Ubuntu Saucy VMs and Fedora
20 VMs, each running on both Ubuntu Trusty and Fedora 20 hosts.
